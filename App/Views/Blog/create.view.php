...
<form name="newArticle" method="post" action="?c=blog&a=store" enctype="multipart/form-data" onsubmit="return validateArticle()">
    ...
    <div class="form-group">
        ...
        <input type="text"  maxlength="255" class="form-control" id="exampleFormControlInput1" name="title" value="<?=$article->getTitle();?>" required>
    </div>

    <div class="form-group">
        <label for="exampleFormControlTextarea1">Popis článku</label>
        <p id="text_input" hidden></p>
        <input  type="text" maxlength="2000" class="form-control" id="exampleFormControlTextarea1" rows="3" name="text" value="<?=$article->getText();?>" required></input>
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Odkaz na článok</label>
        <p id="link_input" hidden></p>
        <input type="url" maxlength="2048" class="form-control" id="exampleFormControlInput1" name="link" value="<?=$article->getLinks();?>">
    </div>
